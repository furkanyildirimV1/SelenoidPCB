# SelenoidPCB
 < Bu proje 12V bir selenoid valfin Arduino veya görev bilgisayarından alınan sinyalle anahtarlanması için PCB tasarımıdır
Selenoid valve circuit PCB design
 - This project is a PCB for switching 12V selenoid valve with Arduino or Mission computer
 - Selenoid valve MOSFET low side switching circuit
